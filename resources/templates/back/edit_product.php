...
if(isset($_GET['id'])){
  ...
  while($row = fetch_array($query)){
        ...
        $product_short_desc = substr(escape_string($row['short_desc']), 0, 50);
        $product_quantity = escape_string($row['product_quantity']);
        $product_image = escape_string($row['product_image']);//Geeft de naam terug vb: bal.jpg
        $product_image = display_image($row['product_image']);//Geeft de locatie van afbeelding terug: uploads/bal.jpg
  }
  update_product();
}; 
?>
...
<aside id="admin_sidebar" class="col-md-4">
    ...
    <div class="form-group">
        ...
        <img src="../../resources/<?php echo $product_image?>" width="300px" alt="">
